About properties-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/properties-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/aranzgeo/properties
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5309&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/properties-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `properties` can be installed with `conda`:
...
```
mamba install properties
```

It is possible to list all of the versions of `properties` available on your platform with `conda`:
...
```
mamba search properties --channel conda-forge
```
...
mamba repoquery search properties --channel conda-forge

# List packages depending on `properties`:
mamba repoquery whoneeds properties --channel conda-forge

# List dependencies of `properties`:
mamba repoquery depends properties --channel conda-forge
```
